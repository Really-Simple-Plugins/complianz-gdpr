...
<div class="cmplz-cookie-field cmplz-field {ignored}" data-cookie_id="{cookie_id}">
    ...
    <div class="{disabledClass}">
        ...
        <select class="cmplz-select2 cmplz_service" type="text" {disabled} name="cmplz_service">
            {services}
        </select>
    </div>
    <div class="{disabledClass}">
    ...
    <div class="{disabledClass}">
        <div><label><?php _e('Cookie function', 'complianz-gdpr')?></label></div>
    ...
    <div class="{disabledClass}">
        ...
        <select class="cmplz-select2-no-additions cmplz_purpose" type="text" {disabled} name="cmplz_purpose">
            {purposes}
        </select>
    </div>
    ...
    <div class="{disabledClass}">
        ...
        <input type="text" {disabled}
               class="cmplz_collectedPersonalData" name="cmplz_collectedPersonalData"
    ...
    <div class="{syncDisabledClass}">
        <label>
            <input {syncDisabled} type="checkbox"
                   ...
                   class="cmplz_sync"
                   {sync}">
            <?php _e('Sync cookie info with cookiedatabase.org', 'complianz-gdpr') ?>
        </label>
    </div>
    <div>
        <label>
