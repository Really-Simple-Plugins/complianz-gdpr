...
class cmplz_tour {
	...
	public function enqueue_assets($hook) {
		if ( ! get_option( 'cmplz_tour_cancelled' ) ) {
			...
			$logo = '<span class="cmplz-tour-logo"><img class="cmplz-tour-logo" style="width: 70px; height: 70px;" src="' . cmplz_url . 'core/assets/images/icon-256x256.png"></span>';
			...
			$steps = array(
				...
				6 => array(
					...
					'text'  => __("Adding Document CSS, disabling certain features, and other settings can be found here. You can also revisit the tour here.", 'complianz-gdpr') ,
	...
	public function restart_tour()
	{
		...
		if (!isset($_POST['cmplz_restart_tour'])) return;
