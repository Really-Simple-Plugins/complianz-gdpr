 ...
 */
const getPostTypes = () => axios__WEBPACK_IMPORTED_MODULE_0___default().get(complianz.site_url + 'wp/v2/types');
...
// SVG icon
const iconEl = () => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Icon, {
...
const selectDocument = _ref => {
  ...
  const [documentSyncStatus, setDocumentSyncStatus] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(attributes.documentSyncStatus);
  const [customDocumentHtml, setCustomDocumentHtml] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const divAttributes = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)([]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    _utils_api__WEBPACK_IMPORTED_MODULE_1__.getDocuments().then(response => {
      ...
      if (documents && 0 !== selectedDocument) {
        ...
        documentData = documents.find(item => {
  ...
  const convertBlockToHtml = html => {
    ...
    Array.from(divAttributes.current).forEach(attribute => {
      divContainer.setAttribute(attribute.nodeName, attribute.nodeValue);
    });
  ...
  let document_status_options = [{
    value: 'sync',
    label: __('Synchronize document with Complianz', 'complianz-gdpr')
  }, {
    value: 'unlink',
    label: __('Edit document and stop synchronization', 'complianz-gdpr')
  }];
  ...
  if (documentSyncStatus === 'sync') {
    return [!!isSelected && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, {
      ...
      onChange: e => onChangeSelectDocumentSyncStatus(e),
    ...
    return [!!isSelected && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, {
      key: "inspector-document-settings"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      title: __('Document settings', 'complianz-gdpr'),
      initialOpen: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelRow, {
