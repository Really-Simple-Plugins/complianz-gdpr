...
if (!class_exists("cmplz_document_core")) {
    class cmplz_document_core
    {
        ...
        public function get_document_html($type, $region=false, $post_id = false)
        {
        ...
        private function replace_fields($html, $paragraph_id_arr, $annex_arr, $post_id, $type, $region)
        {
            //replace references
            ...
            $date = $post_id ? get_the_date('', $post_id) : date(get_option('date_format'), get_option('cmplz_publish_date'));
