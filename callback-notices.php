...
function cmplz_notice_cookie_scan() {
	...
	if ( ( isset( $_SERVER['HTTP_DNT'] )
		...
		cmplz_sidebar_notice( __( "Your browser has the Do Not Track or Global Privacy Control setting enabled.","complianz-gdpr")."&nbsp;".__("This will prevent most cookies from being placed.","complianz-gdpr")."&nbsp;".__("Please run the scan with these browser options disabled.", 'complianz-gdpr' ), 'warning' );
	}
	?>
