...
const Icon = (props) => {
		...
		renderedIcon = {
			html:
				<svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg"
					 viewBox="0 0 448 512" height={iconSize}>
					<path fill={iconColors[iconColor]}
	...
	if (iconName === 'circle-chevron-right') {
		renderedIcon = {
			html:
				<svg
	...
	if (iconName === 'dial-low-light') {
		...
		if (iconName === 'dial-med-low-light') {
			renderedIcon = {
				html:
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
						 height={iconSize}>
		...
		let tooltipClass = props.tooltip ? 'tooltip-' : '';
		return (
			<Tooltip arrow title={props.tooltip} enterDelay={200}>
				<div className={'cmplz-' + tooltipClass + 'icon cmplz-icon-' + iconName + ' cmplz-' + color}>
					{renderedIcon.html}
				</div>
			</Tooltip>
		);
