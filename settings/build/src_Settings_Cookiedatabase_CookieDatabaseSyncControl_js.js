"use strict";
(globalThis["webpackChunkcomplianz_gdpr"] = globalThis["webpackChunkcomplianz_gdpr"] || []).push([["src_Settings_Cookiedatabase_CookieDatabaseSyncControl_js"],{
...
/***/ "./src/Settings/Cookiedatabase/CookieDatabaseSyncControl.js":
/*!******************************************************************!*\
  !*** ./src/Settings/Cookiedatabase/CookieDatabaseSyncControl.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _SyncData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SyncData */ "./src/Settings/Cookiedatabase/SyncData.js");
/* harmony import */ var _Service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Service */ "./src/Settings/Cookiedatabase/Service.js");
...
const CookieDatabaseSyncControl = () => {
  const {
    ...
    errorMessage
  } = (0,_SyncData__WEBPACK_IMPORTED_MODULE_1__.UseSyncData)();
  const {
    addHelpNotice,
    getFieldValue
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (!useCdbApi) {
      setDisabled(true);
      let explanation = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("You have opted out of the use of the Cookiedatabase.org synchronisation.", "complianz-gdpr");
      addHelpNotice('cookiedatabase_sync', 'warning', explanation, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Cookiedatabase', 'complianz-gdpr'));
    }
  }, []);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!curlExists) {
      setDisabled(true);
      let explanation = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("CURL is not enabled on your site, which is required for the Cookiedatabase sync to function.", "complianz-gdpr");
      addHelpNotice('cookiedatabase_sync', 'warning', explanation, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Cookiedatabase', 'complianz-gdpr'));
    }
  }, [curlExists]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (errorMessage !== '') {
      setDisabled(true);
      addHelpNotice('cookiedatabase_sync', 'warning', errorMessage, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Cookiedatabase', 'complianz-gdpr'));
    }
  }, [errorMessage]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!hasSyncableData) {
      setDisabled(true);
      let explanation = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Synchronization disabled: All detected cookies and services have been synchronised.", "complianz-gdpr");
      addHelpNotice('cookiedatabase_sync', 'warning', explanation, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Cookiedatabase', 'complianz-gdpr'));
    }
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (syncDataLoaded && servicesAndCookies.length === 0) {
      let explanation = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("No cookies have been found currently. Please try another cookie scan, or check the most common causes in the article below ", "complianz-gdpr");
      addHelpNotice('cookiedatabase_sync', 'warning', explanation, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('No cookies found', 'complianz-gdpr'), 'https://complianz.io/cookie-scan-results/');
    }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cmplz-cookiedatabase-controls"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    disabled: disabled,
    className: "button button-default",
    onClick: e => Start(e)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Sync", "complianz-gdpr")), languages.length > 1 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    value: language,
    onChange: e => setLanguage(e.target.value)
  }, languages.map((language, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: i,
    value: language
  }, language))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Show deleted cookies", "complianz-gdpr"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "checkbox",
    onClick: e => setShowDeletedCookies(e.target.checked)
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, servicesAndCookies.map((service, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Service__WEBPACK_IMPORTED_MODULE_2__["default"], {
    key: i,
    addCookie: addCookie,
    id: service.id,
    ...
    className: "cmplz-panel__buttons"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    disabled: loadingSyncData,
    onClick: e => onAddServiceHandler(),
    className: "button button-default"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Add service", "complianz-gdpr"))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_5__.memo)(CookieDatabaseSyncControl));
...
//# sourceMappingURL=src_Settings_Cookiedatabase_CookieDatabaseSyncControl_js.js.map