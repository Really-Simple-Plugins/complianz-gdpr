	...
	$fields = $fields + array(
           ...
           'message_optin' => array(
			...
			'documents' => array(
				...
				'comment'            => __( 'On the cookie banner the generated documents are shown. The link is based on the page title.', 'complianz-gdpr' ).
								cmplz_read_more('https://complianz.io'),
			),
