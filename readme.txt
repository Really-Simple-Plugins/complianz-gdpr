...
* Script Center to control scripts, iFrames and plugins per category or serrvice. With dependency functionality and placheholders. 
...
* Automatically anonymizes IP-addresses for integrated statistics tools if needed.
