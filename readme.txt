...
* Proof of Consent; user consent registration which respects the data minimization guideline.
...
* Blocks iFrames, like YouTube/Vimeo embedded video’s and Social iFrames.
* Placeholders for blocked iFrames. Still images from video's and individual placeholders per service.
...
== Premium features ==
* Select both USA, UK and EU as target region with conditional Consent and Cookie Banners.
