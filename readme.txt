...
We cannot guarantee GDPR/COPPA/CCPA/UK-GDPR/PECR/CASL/PIPEDA compliance for your website, because a correct configuration of this plugin by a website administrator is always required. 
= When do I need a Cookie Notice? =
Complianz | GDPR/CCPA Cookie Consent will determine this automatically and based on the laws of the region or regions most of your visitors are coming from. 
= Do I always need a consent checkbox on contact forms? =
Not always. The Complianz Privacy Suite Premium plugin can determine if you need this, based on your answers in the wizard. It mainly depends on the type of information and the reason why your visitor should use the contact form.
= What is the GDPR? =
