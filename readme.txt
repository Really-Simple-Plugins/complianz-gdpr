...
Configure your Cookie Consent, Cookie Notice and Cookie Policy with our Wizard and Cookie Scan. Supports GDPR, AVG, ePrivacy, DSVGO, CCPA and COPPA. 

== Description ==
Complianz | GDPR Cookie Consent supports GDPR, ePrivacy, CCPA, DSVGO, AVG, RGPD and more with a conditional Cookie Notice and customized Cookie Policy based on the results of the built-in Cookie Scan. Blocking 3rd Party Cookies from all major 3rd Party services like Google Analytics, Matomo, Adsense, Facebook, Youtube, Instagram, Vimeo and more. You can configure for US (United States) visitors or European Union (EU) visitors, with specific Cookie Notice and Legal Documents.
...
* Blocks 3rd party cookies like Facebook, Google, Twitter and more.
...
* Integrates seamlessly with Gutenberg, Elementor, Cornerstone, Monsterinsights, WPForms, Gravity Forms, Contact Form 7 (CF7), Woocommerce, Easy Digital Downloads and other popular plugins.
* Integrated with WordPress Privacy features.
* Gutenberg Blocks enabled
* Ready for CCPA (US Privacy Law)
...
* Legal Documents: Customized and legally validated privacy statement (EU & US), cookie policy (EU & US), disclaimer, processing agreements (EU & US) , dataleak reporting tools, created and updated by the law firm ICTRecht Groningen.
...
* Multilanguage support for the cookie notice and legal documents. 6 default languages included.
* Premium Support.
* Premium Updates.
