...
$this->fields = $this->fields + array(
        ...
        'california' => array(
            ...
            'label' => __("Do you target visitors from california?", 'complianz'),
        ...
        'telephone_company' => array(
            ...
            'type' => 'phone',
            'default' => '',
            'document_label' => __('Phone number','complianz').': ',
        ...
        'purpose_personaldata' => array(
            ...
            'help' => __("Also consider future purposes. Regarding personalized products: these are products and/or services which are personalized based on visitor's behavior. E.g. advertisements based on pages visited.", 'complianz'),
            'required' => true,
...
$this->fields = $this->fields + array(
        ...
        'compile_statistics_more_info' => array(
            ...
            'help' => __('If you do not check to always block acquiring IP addresses, the ip addresses will get acquired as soon as the user accepts statistics or higher.', 'complianz') . "<br>" . __('If you can check all three options, you might not need a cookie warning on your site.', 'complianz') . $this->read_more('https://complianz.io/how-to-configure-google-analytics-for-gdpr/'),
            'condition' => array(
        ...
        'compile_statistics_more_info_tag_manager' => array(
            ...
            'help' => __('With Tag Manager you can configure the selective firing of cookies in the Tag Manager dashboard.', 'complianz') . $this->read_more('https://complianz.io/how-to-configure-tag-manager-for-gdpr/'),
            'condition' => array(
        ...
        'fire_scripts_in_tagmanager' => array(
            ...
            'help' => __('If you use Tag Manager to fire scripts on your site, Complianz will automatically enable categories.', 'complianz'),
            'time' => CMPLZ_MINUTES_PER_QUESTION,
        ),
        ...
        'socialmedia_on_site' => array(
            ...
            'options' => array(
                ...
                'instagram' => __('Instagram', 'complianz'),
        ...
        'thirdparty_services_on_site' => array(
            ...
            'options' => array(
                ...
                "videopress" => __('Videopress', 'complianz'),
                "dailymotion" => __('Dailymotion', 'complianz'),
            ),
            'default' => '',
        ...
        'report_unknown_cookies' => array(
            ...
            'help' => __('The scan detected cookies which are not listed in the cookie database. You can help us improve the database by reporting these cookies. If you know what a currently unrecognized cookie is for, please add this to the descriptions below, so we can process that information as well.','complianz'),
            'callback_condition' => array('uses_cookies' => 'yes'),
            'time' => 0,
        ),
        ...
        'configuration_by_complianz' => array(
            ...
            'type' => 'select',
            'default' => 'yes',
            'label' => __("Do you want Complianz to configure your statistics?", 'complianz'),
            'options' => $this->yes_no,
            'help' => __("It's recommended to let Complianz handle the statistics script. This way, the plugin can detect if it needs to be hooked into the cookie consent code or not. But if you have set it up yourself and don't want to change this, you can choose to do so", 'complianz'),
