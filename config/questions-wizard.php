...
//        ),
        ...
        'email_company' => array(
            ...
            'type' => 'email',
            'default' => '',
            'label' => __("What is the e-mail address your visitors can use to contact you about the privacy statement?", "complianz"),
            'required' => true,
            'time' => CMPLZ_MINUTES_PER_QUESTION,
        ),
        'telephone_company' => array(
            ...
            'type' => 'phone',
            'default' => '',
            'label' => __("What is the telephone number your visitors can use to contact you about the privacy statement?", "complianz"),
            'required' => true,
            'time' => CMPLZ_MINUTES_PER_QUESTION,
        ),
    );
