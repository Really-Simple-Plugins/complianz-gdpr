...
$this->fields = $this->fields + array(
        ...
        'custom_privacy_statement_url' => array(
            'step' => STEP_COMPANY,
            'section' => 2,
            'page' => 'wizard',
            'placeholder' => 'https://domain.com/privacy-policy',
            'type' => 'text',
            'label' => __("What is the URL of your privacy policy?", 'complianz'),
            'help' => __("You do not have a privacy policy generated by Complianz Privacy Suite. You can enter the URL of your own privacy policy here.", 'complianz'),
            'required' => true,
