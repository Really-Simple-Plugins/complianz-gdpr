...
$this->pages['br']['cookie-statement']['document_elements'] = array(
    array(
        'content' => '<i>' . sprintf(_x('This Cookie Policy was last updated on %s and applies to citizens and legal permanent residents of Brazil.', 'Legal document cookie policy', 'complianz-gdpr'), '[publish_date]') . '</i>',
    ),
    array(
