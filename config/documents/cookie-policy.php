...
$this->document_elements['cookie-statement'] = array(
    'last-updated' => array(
        'content' => '<i>' . sprintf(_x('This cookie statement was last updated on %s', 'Legal document cookie policy', 'complianz'), '[publish_date]') . '</i>',
    ),
    'introduction' => array(
    ...
    'what-are-cookies' => array(
        'title' => _x('What are cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('A cookie is a small simple file that is sent along with pages of this website and stored by your browser on the hard drive of your computer or another device. The information stored therein may be returned to our servers or to the servers of the relevant third parties during a subsequent visit.', 'Legal document cookie policy', 'complianz'),
    ),
    'what-are-scripts' => array(
        'title' => _x('What are scripts?', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('A script is a piece of programme code that is used to make our website function properly and interactively. This code is executed on our server or on your device.', 'Legal document cookie policy', 'complianz'),
    ),
    ...
    'third-party' => array(
        ...
        'content' => _x('We have made agreements about the use of cookies with other companies that place cookies. However, we cannot guarantee that these third parties handle your personal data in a reliable or secure manner. Parties such as Google are to be considered as independent data controllers within the meaning of the General Data Protection Regulation. We recommend that you read the privacy statements of these companies.', 'Legal document cookie policy', 'complianz'),
        'callback_condition' => 'cmplz_third_party_cookies_active',
    ),
    'cookies' => array(
        'title' => _x('Cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
    ),

    'cookies-subtitle' => array(
        'subtitle' => _x('Technical or functional cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('Some cookies ensure that certain parts of the website work properly and that your user preferences remain known. By placing functional cookies, we make it easier for you to visit our website. This way, you do not need to repeatedly enter the same information when visiting our website and, for example, the items remain in your shopping cart until you have paid. We may place these cookies without your consent.', 'Legal document cookie policy', 'complianz'),
    ),

    //analytical
    'cookies-analytical' => array(
        'subtitle' => _x('Analytical cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('We use analytical cookies to optimize the website experience for our users. With these analytical cookies we get insights in the usage of our website. We ask your permission to place analytical cookies.', 'Legal document cookie policy', 'complianz'),
        'callback_condition' => 'cmplz_uses_statistics',
    ),

    'cookies-analytical-no' => array(
        'subtitle' => _x('Analytical cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('We do not use analytical cookies on this website.', 'Legal document cookie policy', 'complianz'),
        'condition' => array('compile_statistics' => 'no'),
    ),

    //ads
    'cookies-ads-yes' => array(
        'subtitle' => _x('Advertising cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => sprintf(_x('On this website we use advertising cookies, enabling us to personalize the advertisements for you, and we (and third parties) gain insights into the campaign results. This happens based on a profile we create based on your click and surfing on and outside %s. With these cookies you, as website visitor are linked to a unique ID, so you do not see the same ad more than once for example.', 'Legal document cookie policy', 'complianz'), '[domain]'),
        'condition' => array('uses_ad_cookies' => 'yes'),
    ),

    'advertising-cookies-yes-2' => array(
        'content' => _x('Because these cookies are marked as tracking cookies, we ask your permission to place these.', 'Legal document cookie policy', 'complianz'),
        'condition' => array('uses_ad_cookies' => 'yes'),
    ),

    'advertising-cookies-no' => array(
        'subtitle' => _x('Advertising cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('We do not use any advertising cookies on this website.', 'Legal document cookie policy', 'complianz'),
        'condition' => array('uses_ad_cookies' => 'no'),
    ),

    //social media
    'social-media' => array(
        'subtitle' => _x('Social media buttons', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('On our website we do not use social media buttons to promote web pages or share them on social networks.', 'Legal document cookie policy', 'complianz'),
        'condition' => array('uses_social_media' => 'no'),
    ),
    'social-media-yes' => array(
        'subtitle' => _x('Social media buttons', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => sprintf(_x('On our website we have included buttons for %s to promote webpages (e.g. “like”, “pin”) or share (e.g. “tweet”) on social networks like %s. These buttons work using pieces of code coming from %s themselves. This code places cookies. These social media buttons also can store and process certain information, so a personalized advertisement can be shown to you. Please read the privacy statement of these social networks (which can change regularly) to read what they do with your (personal) data which they process using these cookies. The data that is retrieved is anonymized as much as possible. %s are located in the United States.', 'Legal document cookie policy', 'complianz'), '[comma_socialmedia_on_site]', '[comma_socialmedia_on_site]', '[comma_socialmedia_on_site]', '[comma_socialmedia_on_site]'),
        'condition' => array('uses_social_media' => 'yes'),
    ),

    'cookie_names' => array(
        'title' => _x('Placed cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => '<table><tr><td colspan="2"><b>[label]</b></td></tr>
                                 <tr><td colspan="2">' .
                                    _x("Purpose:", 'Legal document cookie policy', 'complianz') . ' [purpose]<br>'.
                                    _x("Retention period:", 'Legal document cookie policy', 'complianz'). ' [storage_duration]<br>'.
                                    _x("Description:", 'Legal document cookie policy', 'complianz') . ' [description]'.
                                 '</td></tr>
                                 <tr>
                                    <td>' . _x("Used names", 'Legal document cookie policy', 'complianz') . '</td>
    ...
    'your-rights' => array(
        ...
        'content' =>
            ...
            '<ul>
                    ...
                    <li>' . _x('Right to rectification: you have the right to supplement, correct, have deleted or blocked your personal data whenever you wish.', 'Legal document cookie policy', 'complianz') . '</li>
    ...
    'enable-disable-removal-cookies' => array(
        'title' => _x('Enabling/disabling and deleting cookies', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('You can use your internet browser to automatically or manually delete cookies. You can also specify that certain cookies may not be placed. Another option is to change the settings of your internet browser so that you receive a message each time a cookie is placed. For more information about these options, please refer to the instructions in the Help section of your browser. Or you can indicate your preferences on the following page:  www.youronlinechoices.eu.',  'Legal document cookie policy','complianz'),
    ),

    'enable-disable-removal-cookies-2' => array(
        'content' => _x('Please note that our website may not work properly if all cookies are disabled. If you do delete the cookies in your browser, they will be placed again after your consent when you visit our websites again.', 'Legal document cookie policy', 'complianz'),
    ),

    'contact-details' => array(
        'title' => _x('Contact details', 'Legal document cookie policy:paragraph title', 'complianz'),
        'content' => _x('For questions and/or comments about our cookie policy and this statement, please contact us by using the following contact details:', 'Legal document cookie policy', 'complianz'),
    ),
    'contact-details-2' => array(
        'content' => '[organisation_name]<br>
                    ...
                    [country_company]<br>
                    ' . _x('Website:', 'Legal document cookie policy', 'complianz') . ' [domain] <br>
                    ' . _x('Email:', 'Legal document cookie policy', 'complianz') . ' [email_company] <br>
                    [telephone_company]',
    ),
