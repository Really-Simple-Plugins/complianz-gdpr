...
$this->pages['eu']['cookie-statement']['document_elements'] = array(
    array(
        'content' => '<em>' . cmplz_sprintf(_x('This Cookie Policy was last updated on %s and applies to citizens and legal permanent residents of the European Economic Area and Switzerland', 'Legal document cookie policy', 'complianz-gdpr'), '[publish_date]') . '</em><br>',
    ),
    array(
