...
$this->document_elements['cookie-statement-us'] = array(
    ...
    'list-of-data-for-sale' => array(
        'title' => __('List of data for sale', 'complianz'),
        'content' => __("Internet activity information, including, but not limited to, browsing history, search history, and information regarding a consumer's interaction with an Internet Web site, application, or advertisement.", 'complianz'),
    ...
    array(
        'title' => __('Selling data to third parties','complianz'),
        'content' => __('The following categories of data are sold to third parties','complianz'),
    ...
    array(
        'title' => __('Selling data to third parties','complianz'),
        'content' => __('We do not sell data to third parties','complianz'),
        'callback_condition' => 'NOT cmplz_sells_personal_data',
    ),


    array(
        'subtitle' => __('Object to selling of personal data to third parties','complianz'),
        'content' => __('You can object to our selling of your personal data by entering your email address and name here. We will then remove your data from the databases we sell to third parties.', 'complianz'),
        'callback_condition' => 'cmplz_sells_personal_data',
    ),
