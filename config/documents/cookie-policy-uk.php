...
$this->document_elements['cookie-statement-uk'] = array(
    'last-updated' => array(
        'content' => '<i>' . sprintf(_x('This cookie statement was last updated on %s and applies to citizens of the United Kingdom.', 'Legal document cookie policy', 'complianz-gdpr'), '[publish_date]') . '</i>',
    ),
    'introduction' => array(
    ...
    'what-are-scripts' => array(
        ...
        'content' => _x('A script is a piece of programme code that is used to make our website function properly and interactively. This code is executed on our server or on your device.', 'Legal document cookie policy', 'complianz-gdpr'),
    ),
    ...
    'third-party' => array(
        ...
        'content' => _x('We have made agreements about the use of cookies with other companies that place cookies. However, we cannot guarantee that these third parties handle your personal data in a reliable or secure manner. Parties such as Google are to be considered as independent data controllers within the meaning of the United Kingdom-GDPR. We recommend that you read the privacy statements of these companies.', 'Legal document cookie policy', 'complianz-gdpr'),
