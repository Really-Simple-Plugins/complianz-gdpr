...
$this->known_cookie_keys = array(
    ...
    'SmartSupp' => array('marketing' => true,
        ...
        'purpose' => __("This cookie is used by Livechat and enables us to provide support to website visitors.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used by Livechat and enables us to provide support to website visitors.", 'complianz'),
    ),
    ...
    'Inspectlet' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Inspectlet", 'complianz'),
        'purpose' => __("These cookies are set by Inspectlet. These cookies are used to collect information about how visitors use our Website.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("These cookies are set by Inspectlet. These cookies are used to collect information about how visitors use our Website.", 'complianz'),
    ),
    ...
    'WordPress_API_Schema' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("WP_API Schema", 'complianz'),
        'purpose' => __("This cookie makes it possible to provide Schema JSON-LD / SEO markup for articles, events, local business, products, recipes, reviews and many more.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie makes it possible to provide Schema JSON-LD / SEO markup for articles, events, local business, products, recipes, reviews and many more.", 'complianz'),
    ),
    ...
    'Advanced_Ads' => array('marketing' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Advanced Ads", 'complianz'),
        'purpose' => __("This cookie makes it possible to implement multiple advertisements om multiple pages on the website.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie makes it possible to implement multiple advertisements om multiple pages on the website.", 'complianz'),
    ),
    'Google_Captcha_Plugin' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Google Captcha", 'complianz'),
        'purpose' => __("This cookie makes it possible show Google Captcha's in a contactform, to determine whether you are a real user or a bot.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie makes it possible show Google Captcha's in a contactform, to determine whether you are a real user or a bot.", 'complianz'),
    ),
    'GDPR_Compliance_Popup' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("WP_API Schema", 'complianz'),
        'purpose' => __("This cookie makes it possible to show a cookie banner.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie makes it possible to show a cookie banner.", 'complianz'),
    ),
    'Plugin_Organizer' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Plugin Organizer", 'complianz'),
        'purpose' => __("This cookie makes it possible to select which plugins will be loaded first.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie makes it possible to select which plugins will be loaded first.", 'complianz'),
    ),
    'Custom_Field_Bulk_Editor' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Custom Field Bulk Editor", 'complianz'),
        'purpose' => __("This cookie is necessary for countdown timers.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is necessary for countdown timers.", 'complianz'),
    ),
    'OptInMonster' => array(
        'functional' => false,
    ...
    'Shopify' => array('functional' => true,
        ...
        'purpose' => __("This cookie is used to be able to deliver webshop functionalities to the website. You can place items in your cart, pay, choose payment methods, etc.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
    ...
    'Algolia_Search' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Algolia", 'complianz'),
        'purpose' => __("This cookie is used to be able to use the Algolia search function on our website.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to be able to use the Algolia search function on our website.", 'complianz'),
    ),
    'Flow_Flow_Plugin' => array('marketing' => true,
        'used_names' => array('ff_news_session'),
        'unique_used_names' => array('ff_news_session'),
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Flow Flow", 'complianz'),
        'purpose' => __("This cookie is used to be able to show social feeds on the website.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to be able to show social feeds on the website.", 'complianz'),
    ),
    'PayPal' => array('functional' => true,
        ...
        'label' => __("PayPal", 'complianz'),
        'purpose' => __("This cookie is used to be able to pay by PayPal.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to be able to pay by PayPal.", 'complianz'),
    ),
    'Max_Mega_Menu' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Max Mega Menu", 'complianz'),
        'purpose' => __("This cookie is used to show a large top menu to improve the user experience.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to show a large top menu to improve the user experience.", 'complianz'),
    ),
    'Intercom_Messenger' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Intercom Messenger", 'complianz'),
        'purpose' => __("This cookie is used by Intercom, which is a live chat plugin on our website. ", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used by Intercom, which is a live chat plugin on our website.", 'complianz'),
    ),
    'Loggly' => array('functional' => true,
        'used_names' => array('logglytrackingsession'),
        'unique_used_names' => array('logglytrackingsession'),
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Loggly", 'complianz'),
        'purpose' => __("This cookie is used by Loggly, which is tool that helps Github users to resolve coding errors on the website. ", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used by Loggly, which is tool that helps Github users to resolve coding errors on the website.", 'complianz'),
    ),
    'Google_Adsense' => array('marketing' => true,
        ...
        'label' => __("Google Adsense", 'complianz'),
        'purpose' => __("This cookie is used by Google Adsense, to show you advertisements based on browsing behavior. ", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used by Google Adsense, to show you advertisements based on browsing behavior.", 'complianz'),
    ),
    'UK_Cookie_Plugin' => array('functional' => true,
        'used_names' => array('catAccCookies'),
        'unique_used_names' => array('catAccCookies'),
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("UK Cookie Plugin", 'complianz'),
        'purpose' => __("This cookie is used by the UK Cookie Plugin to record the fact that you have accepted cookies. ", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used by the UK Cookie Plugin to record the fact that you have accepted cookies.", 'complianz'),
    ),
    ...
    'Q_Translate' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Q Translate", 'complianz'),
        'purpose' => __("This cookie is used to identify which language the page should be used.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to identify which language the page should be used.", 'complianz'),
    ),
    ...
    'Under_Construction_Plugin' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Under Construction Page", 'complianz'),
        'purpose' => __("This cookie is used to show an under construction page.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to show an under construction page.", 'complianz'),
    ),
    ...
    'Avada_Privacy_Bar' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Avada Privacy Bar", 'complianz'),
        'purpose' => __("This cookie is used when the Privacy Consent box is opened to remind your settings.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used when the Privacy Consent box is opened to remind your settings.", 'complianz'),
    ),
    ...
    'Fusion_Theme' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Avada Privacy Bar", 'complianz'),
        'purpose' => __("This cookie is used to use the core functionalities of the Avada Fusion theme. This cookie is strictly necessary to show you all functionalities on our website.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to use the core functionalities of the Avada Fusion theme. This cookie is strictly necessary to show you all functionalities on our website.", 'complianz'),
    ),
    ...
    'WP_GDPR' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("WP GDPR", 'complianz'),
        'purpose' => __("This cookie is used to display a cookie banner.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to display a cookie banner.", 'complianz'),
    ),
    ...
    'Avia_Enfold' => array('functional' => true,
        ...
        'privacy_policy_url' => '[privacy_policy_url]',
        'label' => __("Avia Enfold", 'complianz'),
        'purpose' => __("This cookie is used to enable core functionalities of the Avia Enfold theme. This is a strictly necessary cookie which makes the website perform better.", 'complianz'),
        'storage_duration' => __("365 days", 'complianz'),
        'description' => __("This cookie is used to enable core functionalities of the Avia Enfold theme. This is a strictly necessary cookie which makes the website perform better.", 'complianz'),
    ),
    ...
    'Bleeper_Live_Chat' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Bleeper Live Chat", 'complianz'),
               'purpose' => __("This cookie is used by Bleeper Live Chat and shows you a Live Chat, to help you during your stay on the website.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used by Bleeper Live Chat and shows you a Live Chat, to help you during your stay on the website.", 'complianz'),
           ),
    ...
    'WP_Do_Not_Track' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("WP Do Not Track", 'complianz'),
               'purpose' => __("This cookie is used to stop plugins and themes from adding 3rd party tracking code and cookies. ", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used to stop plugins and themes from adding 3rd party tracking code and cookies.", 'complianz'),
           ),
    ...
    'Posts_View_Counter' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Posts View Counter", 'complianz'),
               'purpose' => __("This cookie is used to count the views on posts and helps the website to perform better. ", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used to count the views on posts and helps the website to perform better.", 'complianz'),
           ),
   'SPO' => array('functional' => true,
                   'used_names' => array('spo_1_fa', 'spo_xxxxxx_fa'),
                   'unique_used_names' => array('spo_1_fa', 'spo_partial_fa'),
                   'privacy_policy_url' => '[privacy_policy_url]',
                   'label' => __("SPO", 'complianz'),
                   'purpose' => __("This cookie is used to remember privacy settings on the website.", 'complianz'),
                   'storage_duration' => __("365 days", 'complianz'),
                   'description' => __("This cookie is used to remember privacy settings on the website.", 'complianz'),
                 ),
  'Breeze' => array('functional' => true,
                   'used_names' => array('breeze_active_tab'),
                   'unique_used_names' => array('breeze_active_tab'),
                   'privacy_policy_url' => '[privacy_policy_url]',
                   'label' => __("Breeze", 'complianz'),
                   'purpose' => __("This cookie speeds up the website by using cache memory.", 'complianz'),
                   'storage_duration' => __("365 days", 'complianz'),
                   'description' => __("This cookie speeds up the website by using cache memory.", 'complianz'),
           ),
  'Rank Math' => array('functional' => true,
                   ...
                   'privacy_policy_url' => '[privacy_policy_url]',
                   'label' => __("Rank Math", 'complianz'),
                   'purpose' => __("This cookie is used by Rank Math, and is used to perform better in Google's search algoritm.", 'complianz'),
                   'storage_duration' => __("365 days", 'complianz'),
                   'description' => __("This cookie is used by Rank Math, and is used to perform better in Google's search algoritm.", 'complianz'),
           ),
           ...
           'Dyamar_Polls' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Dyamar Polls", 'complianz'),
               'purpose' => __("This cookie is used to set up a poll and track their results.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used to set up a poll and track their results.", 'complianz'),
           ),
           ...
           'WP_Reset' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("WP_Reset", 'complianz'),
               'purpose' => __("This cookie is used to quickly reset the website to the default installation. It speeds up the website and the debugging.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used to quickly reset the website to the default installation. It speeds up the website and the debugging.", 'complianz'),
           ),
           ...
           'Beeketing' => array('marketing' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Beeketing", 'complianz'),
               'purpose' => __("This cookie is used by Beeketing and is used to show more benefits of the products on the website. Also shows realtime sales, countdown clock for auctions and more.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used by Beeketing and is used to show more benefits of the products on the website. Also shows realtime sales, countdown clock for auctions and more.", 'complianz'),
           ),
           ...
           'Gutenberg_Advanced' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Gutenberg Advanced", 'complianz'),
               'purpose' => __("This cookie is used by Gutenberg Advanced. It adds missing blocks and configuration for the website builder to deliver visitors the best experience.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used by by Gutenberg Advanced. It adds missing blocks and configuration for the website builder to deliver visitors the best experience.", 'complianz'),
           ),
           ...
           'Elementor' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Elementor Page Builder", 'complianz'),
               'purpose' => __("This cookie is used by Elementor, a WordPress theme. It's a live page builder which makes it easier for the website admin to set up a website that is best for user experience.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used by Elementor, a WordPress theme. It's a live page builder which makes it easier for the website admin to set up a website that is best for user experience.", 'complianz'),
           ),
           ...
           'MaxButtons' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("MaxButtons", 'complianz'),
               'purpose' => __("This cookie is used by MaxButtons to optimize buttons on the website.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used by MaxButtons to optimize buttons on the website.", 'complianz'),
           ),
           ...
           'Bloom' => array('marketing' => true,
               ...
               'unique_used_names' => array('mb-col-preview'),
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("Bloom", 'complianz'),
               'purpose' => __("This cookie is used by Bloom and shows different features to gain e-mail opt-ins on the website.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
               'description' => __("This cookie is used by Bloom and shows different features to gain e-mail opt-ins on the website.", 'complianz'),
           ),
           ...
           'One.com' => array('functional' => true,
               ...
               'privacy_policy_url' => '[privacy_policy_url]',
               'label' => __("One.com", 'complianz'),
               'purpose' => __("This cookie is used a default theme of One.com. It makes it easier for the website owner to make a website and develiver a good usability.", 'complianz'),
               'storage_duration' => __("365 days", 'complianz'),
