...
$this->known_cookie_keys = array(
    ...
    'stripe' => array('functional' => true,
        ...
        'unique_used_names' => array('__stripe_mid', 'partial_stripe'),
    ...
    'add-to-any' => array('functional' => false,
        'used_names' => array('__cfduid'),
        'unique_used_names' => array('__cfduid'),
        'privacy_policy_url' => 'https://addtoany.com',
        'label' => "Add to any",
        'purpose' => __("Add to any", 'complianz'),
        'storage_duration' => __("", 'complianz'),
        'description' => __("description cookie", 'complianz'),
    ),
