...
$this->purposes = array(
    ...
    'support-services' => __('To support services or products that a customer wants to buy or has purchased', 'complianz-gdpr'),
...
$this->collected_info_children = array(
    ...
    'address' => __('a home or other physical address including street name and name of a city or town','complianz-gdpr'),
    'email-child' => __('an email address from the child','complianz-gdpr'),
    'email-parent' => __('an email address from the parent or guardian','complianz-gdpr'),
    'phone' => __('a telephone number','complianz-gdpr'),
