<?php
$this->purposes = array(
	'contact'                     => __( 'Contact - Through phone, mail, email and/or webforms',
		'complianz-gdpr' ),
	'payments'                    => __( 'Payments', 'complianz-gdpr' ),
	'register-account'            => __( 'Registering an account',
		'complianz-gdpr' ),
	'newsletters'                 => __( 'Newsletters', 'complianz-gdpr' ),
	'support-services'            => __( 'To support services or products that a customer wants to buy or has purchased',
		'complianz-gdpr' ),
	'legal-obligations'           => __( 'To be able to comply with legal obligations',
		'complianz-gdpr' ),
...
$this->details_per_purpose_us = array(
	'first-lastname'          => __( 'A first and last name',
		'complianz-gdpr' ),
	'accountname-alias'       => __( 'Account name or alias',
		'complianz-gdpr' ),
	'address'                 => __( 'A home or other physical address, including street name and name of a city or town',
		'complianz-gdpr' ),
	'email'                   => __( 'An email address', 'complianz-gdpr' ),
	'phone'                   => __( 'A telephone number', 'complianz-gdpr' ),
	'social-security'         => __( 'A social security number',
		'complianz-gdpr' ),
	'any-other'               => __( 'Any other identifier that permits the physical or online contacting of a specific individual',
		'complianz-gdpr' ),
	'ip'                      => __( 'IP address', 'complianz-gdpr' ),
	'signature'               => __( 'A signature', 'complianz-gdpr' ),
	'physical-characteristic' => __( 'Physical characteristics or description',
		'complianz-gdpr' ),
	'passport'                => __( 'Passport number', 'complianz-gdpr' ),
	'drivers-license'         => __( "Driver's license", 'complianz-gdpr' ),
	'state-id'                => __( 'State identification card number',
		'complianz-gdpr' ),
	'insurance-policy'        => __( 'Insurance policy number',
		'complianz-gdpr' ),
	'education'               => __( 'Education information',
		'complianz-gdpr' ),
	'employment'              => __( 'Professional or employment-related information',
		'complianz-gdpr' ),
	'employment-history'      => __( 'Employment history', 'complianz-gdpr' ),
	'bank-account'            => __( 'Bank account number', 'complianz-gdpr' ),
	'financial-information'   => __( 'Financial information such as bank account number of credit card number',
		'complianz-gdpr' ),
	'medical'                 => __( 'Medical information', 'complianz-gdpr' ),
	'health-insurcance'       => __( 'Health insurance information',
		'complianz-gdpr' ),
	'commercial'              => __( 'Commercial information, including records of personal property, products or services purchased, obtained, or considered',
		'complianz-gdpr' ),
...
$this->collected_info_children = array(
	...
	'address'            => __( 'a home or other physical address including street name and name of a city or town',
		'complianz-gdpr' ),
	'email-child'        => __( 'an email address from the child',
		'complianz-gdpr' ),
	'email-parent'       => __( 'an email address from the parent or guardian',
		'complianz-gdpr' ),
	'phone'              => __( 'a telephone number', 'complianz-gdpr' ),
