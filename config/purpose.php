...
$this->purposes = array(
	...
	'selling-data-thirdparty'     => __( 'To sell or share data with a third party', 'complianz-gdpr' ),
	'deliveries'                  => __( 'Deliveries', 'complianz-gdpr' ),
);
...
$this->details_per_purpose_us = array(
	...
	'marital-status'          => __( 'Marital status','complianz-gdpr' ),
	'date-of-birth'           => __( 'Date of birth','complianz-gdpr' ),
	'sex'                     => __( 'Sex','complianz-gdpr' ),
	'photos'                  => __('Photos', 'complianz-gdpr'),
	'social-media'            => __('Social Media accounts', 'complianz-gdpr'),
