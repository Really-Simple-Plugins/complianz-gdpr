...
if (!class_exists("cmplz_config")) {
    ...
    class cmplz_config
    {
        ...
        public $upgrade_cookies = array(
	        ...
	        '_hjUserId', '_hjIncludedInSample', '_hjMinimizedTestersWidgets', '_hjClosedSurveyInvites', '_hjDonePolls', '_hjMinimizedPolls', '_hjDoneTestersWidgets',
	        '_hp2_ses',
	        '_iub_cs-xxxx',
	        '_jsuid',
	        '_lscache_vary',
	        ...
	        'fbm_', 'actppresence', 'sb', 'csm', 'c_user', 'frstxs', 'datr', '_fbp',
	        'fca_eoi_pagecount',
	        'ff_news_session',
	        'fs_uid',
	        ...
	        'wp-api-schema-model', 'wp-api-schema-model_xxxxxx',
	        'wp-donottrack_feed',
	        'wp-reset-tabs',
	        'wpdiscuz_last_visit',
