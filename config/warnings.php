...
$this->warning_types = array(
    ...
    'plugins-changed' => array(
        ...
        'label_error' => __('Plugin changes have been detected.', 'complianz-gdpr') . " " . sprintf(__('Please review step %s of the wizard for changes in plugin privacy statements and cookies.', 'complianz-gdpr'), STEP_PLUGINS),
    ),
