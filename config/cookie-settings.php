...
$this->fields = $this->fields + array(
		...
		'soft_cookiewall' => array(
			...
			'table'   => true,
			'help'    => sprintf( __( "You can grey out the rest of the website, which makes it look like a cookie wall, but it is dismissible: a 'soft' cookie wall. This is not visible in preview, as it would prevent editing the options. Read more about the soft cookie wall in this %sarticle%s.",
				'complianz-gdpr' ),
		...
		'revoke' => array(
			...
			'table'     => true,
			'help'      => __( 'The text that appears on the revoke button, which shows when a choice has been made in the cookie warning.',
				'complianz-gdpr' ),
			'condition' => array(
		...
		'category_all' => array(
			...
			'label'              => __( "Accept marketing cookies text",
				'complianz-gdpr' ),
			'table'              => true,
			'condition'          => array( 'use_categories' => true ),
			'callback_condition' => 'cmplz_uses_optin',
		...
		'category_prefs' => array(
			...
			'label'              => __( "Preferences cookies text",
				'complianz-gdpr' ),
			'table'              => true,
			'condition'          => array( 'use_categories' => true ),
		...
		'category_stats' => array(
			...
			'label'              => __( "Statistics cookies text",
				'complianz-gdpr' ),
		...
		'hide_revoke' => array(
			...
			'table'   => true,
			'help'    => __( 'If you want to hide the revoke button, enable this check box. The revoke button will normally show after making a choice.',
				'complianz-gdpr' ),
