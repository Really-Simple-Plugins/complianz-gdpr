...
function cmplz_wordpress_register_cookies(){
	if ( function_exists( 'wp_add_cookie_info' ) ) {
		...
		wp_add_cookie_info( 'complianz_consent_status', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences', false );
		wp_add_cookie_info( 'complianz_policy_id', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences', false);
		wp_add_cookie_info( 'complianz_config', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences', false);
		wp_add_cookie_info( 'complianz_scan_token', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences' , false);
		wp_add_cookie_info( 'cmplz_id', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences', false);
		wp_add_cookie_info( 'cmplz_all', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences', false);
		wp_add_cookie_info( 'cmplz_event_*', 'Complianz GDPR/CCPA Cookie Consent', 'functional', $expiry, 'store cookie consent preferences' , false);
	}
}
