...
function cmplz_wc_google_analytics_integration_show_compile_statistics_notice( $args ) {
	cmplz_notice( sprintf( __( "You use %s, which means the answer to this question should be Google Analytics.", 'complianz-gdpr' ), 'WooCommerce Google Analytics Integration' ) );
}
...
add_filter( 'cmplz_warnings', 'cmplz_wc_google_analytics_integration_filter_warnings' );
