		...
		public function get_amp_banner(){
            ...
            <amp-consent layout="nodisplay" id="consent-element">
                ...
                <div id="cmplz-consent-ui">
                	<div class="cmplz-consent-message">'.$this->banner->message_optin_x.'</div>
                    <button on="tap:consent-element.accept" role="button">'.$this->banner->accept_x.'</button>
                    <button on="tap:consent-element.reject" role="button">'.$this->banner->dismiss_x.'</button>
                </div>
                '.$revoke.'
...
//
		...
		public function amp_styles($post_template){
			...
			if ($this->banner->use_custom_cookie_css && strlen($this->banner->custom_css_amp)>0 ) echo $this->banner->custom_css_amp;
		}
