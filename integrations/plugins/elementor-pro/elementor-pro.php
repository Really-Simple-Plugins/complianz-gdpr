...
class CMPLZ_Elementor_Pro {
	...
	public function cmplz_filter_elementor_pro_fields( $fields ) {
		...
		$fields['create_banner_elementor'] = array(
			...
			'default' => 'no',
			'required' => false,
			'comment' => __('If you choose to create your Cookie Banner with Elementor Pro we will import our default template.', 'complianz-gdpr').cmplz_read_more('https://complianz.io/intergrations/elementor-pro'),//@todo url
		);
		...
		$fields['create_legal_hub_elementor'] = array(
			...
			'required' => false,
			'comment' => __('If you choose to create your Legal Hub with Elementor Pro we will import our default template.', 'complianz-gdpr').cmplz_read_more('https://complianz.io/intergrations/elementor-pro'),//@todo url
		);
