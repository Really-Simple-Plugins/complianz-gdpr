 ...
 * @since 1.0.0
 */
class CMPLZ_Accept_Button extends Widget_Button {

	public function __construct($data = [], $args = null)
	{
		parent::__construct($data, $args);
		wp_register_style( 'cmplz-accept-button-widget-style', cmplz_url . 'integrations/plugins/elementor-pro/assets/css/accept-button.min.css', [], cmplz_version);
	...
	public function get_style_depends() {
		return [ 'cmplz-accept-button-widget-style' ];
	}
    ...
    public function get_title() {
        return esc_html__( 'Accept Button', 'complianz-gdpr' );
    }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accept', 'complianz-gdpr' ),
				'placeholder' => esc_html__( 'Accept', 'complianz-gdpr' ),
			]
		);
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'button', 'class', 'cmplz-accept' );
    ...
    protected function content_template() {
        ...
        <div class="elementor-button-wrapper">
			<a id="{{ settings.button_css_id }}" class="elementor-button elementor-size-{{ settings.size }} elementor-animation-{{ settings.hover_animation }} cmplz-accept" role="button">
