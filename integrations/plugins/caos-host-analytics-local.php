...
{
	cmplz_notice(sprintf(__("You use %s, which means the answer to this question should be Google Analytics.", 'complianz-gdpr'), 'CAOS host analytics locally'));
}
add_action('cmplz_notice_compile_statistics', 'cmplz_caos_show_compile_statistics_notice', 10, 1);
