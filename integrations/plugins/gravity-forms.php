...
function cmplz_gravityforms_add_consent_checkbox($form_id)
{
    ...
    $label = __('To submit this form, you need to accept our privacy statement', 'complianz-gdpr');
    ...
    if (!$complianz_field_exists) {
        ...
        $consent_box->description = '<a href="' . COMPLIANZ()->document->get_permalink('privacy-statement','eu', true) . '">' . __("Privacy statement", "complianz-gdpr") . '</a>';
